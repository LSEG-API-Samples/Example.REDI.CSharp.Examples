...
{
    //Use the same function as Vertical strategy
    class RatioStrategy : IStrategy
    {

        protected Options options;

        protected string name = "Ratio Orders";
        ...
        public void SendOrder()
        {
            ...
            {
                string tmpStrike = Utils.GetStrikePrice(options.Symbol, options.Type2, options.Date2, 1);
                if (tmpStrike == null)
                {
        ...
        private void SendOrderInt()
        {
            ...
            if(options.Ratio1 > 1)
                objOrder.SetQuantity(1, options.Ratio1.ToString());
            ...
            if (options.Ratio2 > 1)
                objOrder.SetQuantity(2, options.Ratio2.ToString());
        ...
        public bool VerifyArguments()
        {
            ...
            if (!Utils.TypeList.Contains(options.Type2))
            {
                ret = false;
        ...
        private void PrintOrder()
        {
            ...
            Console.WriteLine("==============================");
            Console.WriteLine("Leg 1: {0} {1} {2} {3} {4} {5}",
                options.Ratio1.ToString(),
                options.Type1,
                options.Side1,
                options.Position1,
                options.Date1,
                options.Strike1.ToString());
            Console.WriteLine("Leg 2: {0} {1} {2} {3} {4} {5}",
                options.Ratio2.ToString(),
                options.Type2,
                options.Side2,
                options.Position2,
                options.Date2,
